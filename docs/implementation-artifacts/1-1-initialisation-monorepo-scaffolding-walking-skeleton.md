...
1. **Monorepo Structure**: The following directories exist: `backend/`, `frontend/`, `infra/`, `docs/`.
2. **Backend Skeleton**: 
...
4. **CI/CD Foundation**: `.github/workflows/ci.yml` exists and performs compilation for both modules.
5. **Docker Foundation**: `docker-compose.yml` exists with a PostgreSQL 16 service.
