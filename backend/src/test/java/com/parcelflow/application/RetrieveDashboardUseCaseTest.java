...
class RetrieveDashboardUseCaseTest {
    ...
    void shouldReturnGroupedParcelsFromRepository() {
        ...
        Parcel p1 = new Parcel(ParcelId.random(), "T1", "DHL", LocalDate.now(), ParcelStatus.AVAILABLE, pp1, null, null);
        Parcel p2 = new Parcel(ParcelId.random(), "T2", "UPS", LocalDate.now(), ParcelStatus.AVAILABLE, pp1, null, null);
        Parcel p3 = new Parcel(ParcelId.random(), "T3", "La Poste", LocalDate.now(), ParcelStatus.AVAILABLE, pp2, null, null);
