...
class InMemoryParcelRepositoryTest {
    ...
    void shouldUpsertParcelOnSave() {
        ...
        Parcel parcel1 = new Parcel(ParcelId.random(), "TRK123", "DHL", LocalDate.now(), ParcelStatus.AVAILABLE, null, null, null, BarcodeType.QR_CODE);
        ...
        Parcel parcel2 = new Parcel(ParcelId.random(), "TRK123", "DHL", LocalDate.now().plusDays(1), ParcelStatus.PICKED_UP, null, null, null, BarcodeType.QR_CODE);
